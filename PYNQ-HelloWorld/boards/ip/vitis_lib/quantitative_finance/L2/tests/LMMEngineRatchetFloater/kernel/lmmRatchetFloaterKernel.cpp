 ...
 */
/**
 * @brief Kernel wrapper for Libor Maket Model Ratchet Floater pricer
 */
#include "lmmRatchetFloaterKernel.hpp"
...
#pragma HLS INTERFACE s_axilite port = rfX bundle = control
#pragma HLS INTERFACE s_axilite port = rfY bundle = control
#pragma HLS INTERFACE s_axilite port = rfAlpha bundle = control
...
#pragma HLS UNROLL
        pricer[i][0].init(notional, rfX, rfY, rfAlpha);
    }
