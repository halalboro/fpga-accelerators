 ...
 */
#ifndef _LMM_RATCHET_CAP_KERNEL_H_
#define _LMM_RATCHET_CAP_KERNEL_H_
...
typedef xf::fintech::lmmRatchetCapPricer<TEST_DT, TEST_MAX_TENORS> TEST_PT;
...
#endif // _LMM_RATCHET_CAP_KERNEL_H_