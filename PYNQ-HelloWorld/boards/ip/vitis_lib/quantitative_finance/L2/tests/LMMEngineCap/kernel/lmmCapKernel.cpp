 ...
 */
/**
 * @brief Kernel wrapper for Libor Maket Model Cap pricer
 */
#include "lmmCapKernel.hpp"
...
#pragma HLS INTERFACE s_axilite port = caprate bundle = control
...
#pragma HLS UNROLL
        pricer[i][0].init(notional, caprate);
    }
