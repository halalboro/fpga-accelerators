...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("s_axis_video_TDATA", 48, hls_in, 8, "axis", "in_data", 1),
	Port_Property("s_axis_video_TVALID", 1, hls_in, 14, "axis", "in_vld", 1),
	Port_Property("s_axis_video_TREADY", 1, hls_out, 14, "axis", "in_acc", 1),
	Port_Property("s_axis_video_TKEEP", 6, hls_in, 9, "axis", "in_data", 1),
	Port_Property("s_axis_video_TSTRB", 6, hls_in, 10, "axis", "in_data", 1),
