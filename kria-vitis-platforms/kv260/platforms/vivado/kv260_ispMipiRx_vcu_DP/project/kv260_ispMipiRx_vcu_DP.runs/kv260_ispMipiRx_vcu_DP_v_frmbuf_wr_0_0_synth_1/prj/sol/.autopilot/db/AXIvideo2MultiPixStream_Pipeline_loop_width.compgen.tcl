...
set id 21
set name kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_mux_83_8_1_1
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { axi_data_V_2 { I 48 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_img \
    op interface \
    ports { img_din { O 48 vector } img_num_data_valid { I 2 vector } img_fifo_cap { I 2 vector } img_full_n { I 1 bit } img_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { axi_data_V_3_out { O 48 vector } axi_data_V_3_out_ap_vld { O 1 bit } } \
} "
}
