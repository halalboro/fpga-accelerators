...
entity kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_FrmbufWrHlsDataFlow is
port (
...
architecture behav of kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_FrmbufWrHlsDataFlow is 
...
attribute shreg_extract : string;
    ...
    signal MultiPixStream2Bytes_U0_bytePlanes_plane01_din : STD_LOGIC_VECTOR (127 downto 0);
    signal MultiPixStream2Bytes_U0_bytePlanes_plane01_write : STD_LOGIC;
    signal MultiPixStream2Bytes_U0_bytePlanes_plane12_din : STD_LOGIC_VECTOR (127 downto 0);
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_AXIvideo2MultiPixStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_MultiPixStream2Bytes IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_Bytes2AXIMMvideo IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        bytePlanes_plane01_dout : IN STD_LOGIC_VECTOR (127 downto 0);
        bytePlanes_plane01_num_data_valid : IN STD_LOGIC_VECTOR (9 downto 0);
        bytePlanes_plane01_fifo_cap : IN STD_LOGIC_VECTOR (9 downto 0);
        bytePlanes_plane01_empty_n : IN STD_LOGIC;
        bytePlanes_plane01_read : OUT STD_LOGIC;
        bytePlanes_plane12_dout : IN STD_LOGIC_VECTOR (127 downto 0);
        bytePlanes_plane12_num_data_valid : IN STD_LOGIC_VECTOR (9 downto 0);
        bytePlanes_plane12_fifo_cap : IN STD_LOGIC_VECTOR (9 downto 0);
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w32_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w15_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w16_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w6_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w48_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w12_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w128_d480_B IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w15_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w6_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_start_for_MultiPixStream2Bytes_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_start_for_Bytes2AXIMMvideo_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc_U0 : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    AXIvideo2MultiPixStream_U0 : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_AXIvideo2MultiPixStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    MultiPixStream2Bytes_U0 : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_MultiPixStream2Bytes
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Bytes2AXIMMvideo_U0 : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_Bytes2AXIMMvideo
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    HwReg_frm_buffer_c_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w32_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    HwReg_frm_buffer2_c_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w32_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    WidthInBytes_c9_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w15_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    stride_c_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w16_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    video_format_c11_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w6_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    img_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w48_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    height_c10_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w12_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    bytePlanes_plane0_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w128_d480_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    bytePlanes_plane1_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w128_d480_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    WidthInBytes_c_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w15_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    height_c_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w12_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    video_format_c_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_fifo_w6_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_MultiPixStream2Bytes_U0_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_start_for_MultiPixStream2Bytes_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Bytes2AXIMMvideo_U0_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_0_start_for_Bytes2AXIMMvideo_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
