...
//--------------------------------------------------------------------------------
//Command: generate_target bd_fb21.bd
//Design : bd_fb21
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_fb21,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_fb21,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "kv260_ispMipiRx_vcu_DP_mipi_csi2_rx_subsyst_0_0.hwdef" *) 
module bd_fb21
   (clkoutphy_out,
    csirxss_csi_irq,
